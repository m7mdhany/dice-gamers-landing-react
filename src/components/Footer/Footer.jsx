...
const Footer = () => {
  return (
    <div dir='ltr' className='overflow-hidden relative items-center md:h-32 md:px-40 py-2 bg-black rounded-t-lg text-white flex md:flex-row flex-col-reverse justify-between'>
